...
Official NWS CLI products via [IEM](https://mesonet.agron.iastate.edu). Gaps filled with [ACIS](https://www.rcc-acis.org) estimates (tagged `source: acis`). See [Data Sources](/data-sources/) for report type priority and settlement rules.
