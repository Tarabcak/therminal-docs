...
Live observations from [AWC](https://aviationweather.gov) (5-second polling). Historical from [IEM](https://mesonet.agron.iastate.edu) and [NOAA ISD](https://www.ncei.noaa.gov/products/land-based-station/integrated-surface-database). See [Data Sources](/data-sources/) for full details.
