...
The [Python SDK](/sdk/) (v1.0.3) provides domain-split clients, a config file, and **WeatherLive** for real-time METAR observations from AWC with schema-identical output to historical data.
...
- [Python SDK](/sdk/) — Domain clients, WeatherLive, config, ML features
