...
The [Python SDK](/sdk/) (v1.0.7) provides domain-split clients, a config file, and **WeatherLive** for real-time METAR observations from AWC with schema-identical output to historical data.
